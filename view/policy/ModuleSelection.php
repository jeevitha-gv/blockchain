...
<h4>Getting started with Blockchain</h4>
...
<div class="container" style="background-color: white;width: 75%;">
  <h5><strong>Learn about Blockchain</strong></h5><hr>

<div class="form-group row">
<div class="col-sm-10">
<p style="color: #141f1f;">View the slideshow to see what Blockchain is all about.</p>
...
<div class="form-group row">
<div class="col-sm-10">
<p style="color: #141f1f;">Getting started with the Marketing Blockchain
</p>
...
All the important stuff including what's free vs paid, how we secure your data, and which other tools Blockchain works with.</P>
</div>
<div class="col-sm-2">
<a href="#" data-toggle="modal" data-target="#myModal3"><img src="video1.png" title="Read FAQ" width="40" height="40"> </a>
</div>
</div><hr>
<div class="form-group row">
<div class="col-sm-10">
<p style="color: #141f1f;">Idea Blockchain</p>
...
<div class="form-group row">
<div class="col-sm-10">
<p style="color: #141f1f;">Investigator Blockchain</p>
...
<div class="form-group row">
<div class="col-sm-10">
<p style="color: #141f1f;">Reviewer Blockchain
</p>
...
<div class="form-group row">
<div class="col-sm-10">
<h5><strong>Explore Blockchain</strong>
</h5>
</div>
...
<div class="col-sm-2">
<a href="http://Blockchain.com/Blockchain/signup.php"><img src="contact.png" title="create conatct" width="40" height="40"></a>
</div>
</div>
</div>
<div class="container" style="background-color: white;width: 75%;">
...
<div class="modal fade" id="myModal9" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" id ="btn" class="btn btn-default" onclick="second(this);">okay</button>
      </div>
    </div>
  </div>
</div>
...
$(document).ready(function()
{
  ...
  window.onload = function() {
    var selItem = sessionStorage.getItem("myProgress");  
    $('#myProgress').val(selItem);
    }
    $('#myProgress').change(function() {
        var selVal = $(this).val();
