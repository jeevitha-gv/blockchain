...
<div class="kt-portlet" style="margin-top: -10%;">
...
Blower
  ...
  <form class="kt-form kt-form">
       ...
       <div class="input-group after-add-more col-1 mb-3">
                  <button class="btn add-more" type="button" title="Add Row"><i style="color:green;font-size:20px; margin-left:-25px;margin-top:25px" class="fa flaticon-plus"></i></button>
              </div>
              </div>                                    
       <div class="copy hide">
          ...
          <div class="col-3">
            ...
            <input type="text" class="form-control" id="Department1">
                 ...
                 <div class="input-group col-md-1  mb-3">
                    <button class="btn remove" type="button" title="Delete Row"><i class="fa flaticon-cancel" style="color: red;font-size: 20px; margin-left:-25px;margin-top: 25px;"></i></button>
                </div>
                </div>
              </div>
      </div>
...
<button class="btn add-more3 mb-3"type="button" title="Add Row"><i style="color:green;font-size:20px; margin-left:-15px;margin-top: 25px;" class="fa flaticon-plus"></i></button>
             </div>
          </div>
   <div class="copy6 hide">
      ...
      <div class="col-md-3">
       ...
       <button class="btn remove3 mb-3" type="button" title="Delete Row"><i class="fa flaticon-cancel" style="color: red;font-size: 20px;margin-left:-15px;margin-top: 25px;"></i></button>
    ...
    <br>
          ...
          <div id="auth"  style="margin-left: 16%;">
        ...
        <input type="text" placeholder="Phone" class="form-control" id="PhoneAuth">
          ...
          <div class="form-group row mb-3">
            ...
            <div class="col-9">
              <textarea type="text" placeholder="Incident Information" rows="6" class="form-control mb-3" id="nature"></textarea>
               <span id="san8" style="color:red;"></span>  
            </div>

            <div class="col-1">
               <label aria-hidden="true" style="margin-left:28px; margin-top: -5%;">Artifacts<i class="btn btn-danger btn-block"><span class="flaticon-attachment"></span></i>
                       ...
                       <div id="donates" style="margin-left: 16%;">
                        <div class="form-group row">
                         <div class="col-4">
                                ...
                                <div class="">
                           <strong style="margin-left: 480px;">OR</strong>  
                                 <div class="form-group row">
                               <div class="col-md-11 input_val">
                           <input type="text" placeholder="BitCoin Address" id="btcaddress" class="form-control">
                                      <center><strong>OR</strong></center>  
                                      </div><br><br>
                       <img src="./blower/BTC1.png" height="45" width="66" alt="Bit">
                            <div class="col-md-11 input_val">
                      <input type="text" placeholder="Ethereum Address" id="ethaddress" class="form-control">
                                      </div>
                                   <img src="./blower/ETC.png" height="45" width="66">
