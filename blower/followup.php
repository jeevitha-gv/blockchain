 ...
 <input type="text" id="createdAt" name="createdAt" class="form-control"value="<?php echo $rows['createat']; ?>"disabled style=";background: transparent;color: white;">  
      ...
      <div class="row form-group">
        ...
        <!--   <span id="companyName" class="form-control"  style="background: transparent;color: white;"></span> -->
             <input type="text" id="company" name="company" class="form-control"value="<?php echo $rows['company']; ?>"disabled style=";background: transparent;color: white;">
        </div>
        <div class="col-md-6">
          <label >Category</label><br>
           <input type="text" id="category" name="category" class="form-control"value="<?php echo $rows['category']; ?>"disabled style=";background: transparent;color: white;">
    ...
    <div class="row form-group">
      <div class="col-md-6">
         ...
         <!--  <span id="association" class="form-control"  style="background: transparent; color: #ffffff;" ></span> -->
            <input type="text" id="relationship" name="relationship" class="form-control"value="<?php echo $rows['relationship']; ?>"disabled style=";background: transparent;color: white;">
        </div>
        <div class="col-md-6">
          <label >Encounter</label><br>
          <input type="text" id="encounter" name="encounter" class="form-control"value="<?php echo $rows['encounter']; ?>"disabled style=";background: transparent;color: white;">
        </div>
    </div>
  </div><br>
  <div class="panel-body" style="border: 1px solid #e2e5ec; border-color: #A1E6EA">
        ...
        <div class="col-md-6">
          <label >Department</label><br>
           <input type="text" id="department" name="department" class="form-control"value="<?php echo $rows['department']; ?>"disabled style=";background: transparent;color: white;">
        </div>
        <div class="col-md-6">
    ...
    <div class="row form-group" class="container hide" id="authknowsarea">
          ...
          <label>Authority's Name</label><br>
            <input type="text" id="nameauth" name="nameauth" class="form-control"value="<?php echo $rows['nameauth']; ?>"disabled style=";background: transparent;color: white;">
           </div>
          <div class="col-md-6">
          <label >Authority's Email ID</label><br>
         <input type="text" id="emailauth" name="emailauth" class="form-control"value="<?php echo $rows['emailauth']; ?>"disabled style=";background: transparent;color: white;">
           </div>
   ...
   <div class="row form-group">
     <div class="col-md-6">
          ...
          <!-- <span id="PhoneAuth" class="form-control"  style="background: transparent; color: #ffffff;"></span> -->
           <input type="text" id="phoneauth" name="phoneauth" class="form-control"value="<?php echo $rows['phoneauth']; ?>"disabled style=";background: transparent;color: white;" >
         </div>
          <div class="col-md-6">
          <label >Authorities Know</label><br>
           <input type="text" id="authorityknows" name="authorityknows" class="form-control"value="<?php echo $rows['authorityknows']; ?>"disabled style=";background: transparent;color: white;">
        </div>
   </div>
 </div>
          <br>
