...
<!--begin::Global Theme Styles(used by all pages) -->
  ...
  <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url(./assets/media//bg/bg-11.jpg);">
        ...
        <div class="kt-login__signin">
          ...
          <form class="kt-form" method="post" action="">
            ...
            <div class="kt-login__actions">
              <button type="submit"  name="login" class="btn btn-pill kt-login__btn-primary">Sign In</button>
            </div>
          </form>
        </div>
