...
jQuery(document).ready(function() {
 ...
 var table = $('#kt_table_1').DataTable({
      ...
      columns: [
          ...
          { data: "association"},
            { data: "place"},
              ...
              {data:"DepartmentPR"},
              // {data:"monetaryValue"}
             { defaultContent: "<a class='btn btn-primary' style='color:white;'>Idea Analyse</a>"}
     ...
     $('#kt_table_1 tbody').on( 'click', 'a', function () {
      ...
      // alert(data["tipNo"] );
      window.location='investigator/indexi.php?tip_no='+data["tipNo"];
...
<?php
include '../investigator/sidemenui.php';
 ?>
