  ...
  <a href="idealogin.php">
   <img src="Idea.png" height="40" class="idea1" title="Followup Idea" style=" border-radius: 50%; border-width: 2px;   border-color: red;   border-style: solid;">
        ...
        <div class="container " style="margin-top: 180px;">
           <h2 class="d-flex justify-content-center mb-3">Wanna be heard....</h2>
                      <h1 class="d-flex justify-content-center mb-3"><b>#SpeakUP</b></h1>
          ...
          <div class="row d-flex justify-content-center" >
               ...
               <a href="option.php">
           <img src="./head.png" title="" height="170" class="face">        
            </a>
          </div>
              </div>
        </div>
