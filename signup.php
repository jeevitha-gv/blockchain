...
<!--begin::Global Theme Styles(used by all pages) -->
	...
	<div class="kt-grid kt-grid--ver kt-grid--root kt-page" >
		...
		<div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v6 kt-login--signin" id="kt_login" style="background-image: url(./assets/media/bg/bg-7.jpg);">
                ...
                <div class="kt-login">
                        ...
                        <div class="kt-login__signin">
                            ...
                            <div class="kt-login__head">
                                ...
                                <h2 style="font-family: inherit;color: white;">Try demo free for 15 days</h2>
                            </div><br>
