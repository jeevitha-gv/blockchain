  ...
  if(isset($_POST['submit']))
  {
   $ran=$_POST['ran'];
    $secretkey=$_POST['secretkey'];
      $sql="SELECT secretkey,ran FROM blower where ran='$ran' and secretkey='$secretkey'";
     $result=mysqli_query($link,$sql);
             ...
             {    
               ...
               {
                  echo "Sucessfully";
                header("location:/blockchain/blower/followup.php?ran=".$rows['ran']);
               }
             }
             else
               {
...
phone.onpaste = cleanPhoneNumber;
      ...
      <script type="text/javascript">
      var phone = document.getElementById('secretkey'),
    cleanPhoneNumber;
